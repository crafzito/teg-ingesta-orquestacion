...
| `context-engineering` | Apply Context Engineering principles to design, optimize, and manage context for AI agent systems. Ensures the right information is loaded at the right time for optimal LLM decision-making. Use when designing agent context, optimizing context windows, building context packs, or preventing context collapse. | [SKILL.md](skills/context-engineering/SKILL.md) |
| `database-migration` | Execute database migrations across ORMs and platforms with zero-downtime strategies, data transformation, and rollback procedures. Use when migrating databases, changing schemas, performing data transformations, or implementing zero-downtime deployment strategies. | [SKILL.md](skills/database-migration/SKILL.md) |
...
| `fastapi-templates` | Create production-ready FastAPI projects with async patterns, dependency injection, and comprehensive error handling. Use when building new FastAPI applications or setting up backend API projects. | [SKILL.md](skills/fastapi-templates/SKILL.md) |
...
| `manual-generator` | Generate comprehensive technical manuals, runbooks, operational documentation, and knowledge transfer documents. Use when creating manuals, generating documentation, writing runbooks, or building knowledge transfer materials. | [SKILL.md](skills/manual-generator/SKILL.md) |
| `prompt-architect` | Design production-grade structured prompts following the A4F 8-point pattern for agentic systems. Use when creating prompts, designing master prompts, structuring AI delegations, or building metaprompts. | [SKILL.md](skills/prompt-architect/SKILL.md) |
...
| `react-modernization` | Upgrade React applications to latest versions, migrate from class components to hooks, and adopt concurrent features. Use when modernizing React codebases, migrating to React Hooks, or upgrading to latest React versions. | [SKILL.md](skills/react-modernization/SKILL.md) |
...
| `react-state-management` | Master modern React state management with Redux Toolkit, Zustand, Jotai, and React Query. Use when setting up global state, managing server state, or choosing between state management solutions. | [SKILL.md](skills/react-state-management/SKILL.md) |
...
| `swe-delegation` | Delegate complex software engineering tasks to AI agents with structured context, phases, and DoD. Use when delegating development tasks, creating structured SWE assignments, or building phased development plans. | [SKILL.md](skills/swe-delegation/SKILL.md) |
| `tailwind-design-system` | Build scalable design systems with Tailwind CSS v4, design tokens, component libraries, and responsive patterns. Use when creating component libraries, implementing design systems, or standardizing UI patterns. | [SKILL.md](skills/tailwind-design-system/SKILL.md) |
...
| `technical-audit` | Perform comprehensive technical audits covering code quality, security, performance, scalability, and technical debt. Generate prescriptive reports with severity classification and actionable fixes. | [SKILL.md](skills/technical-audit/SKILL.md) |
...
| Creating structured prompts, designing master prompts, building metaprompts | `prompt-architect` |
| Delegating development tasks to AI agents, structuring SWE assignments | `swe-delegation` |
| Auditing code quality, generating QA reports, security reviews | `technical-audit` |
| Generating technical manuals, creating runbooks, writing operational documentation | `manual-generator` |
| Designing agent context, optimizing context windows, preventing context collapse | `context-engineering` |
